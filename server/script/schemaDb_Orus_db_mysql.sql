...
CREATE DATABASE IF NOT EXISTS `orus_db`;
USE `orus_db`;
...
--
-- Struttura della tabella `taxpayerinfo`
--
...
INSERT INTO `orus_db`.`user` (`username`, `password`, `_id`) VALUES ('admin', '62f264d7ad826f02a8af714c0a54b197935b717656b80461686d450f7b3abde4c553541515de2052b9af70f710f0cd8a1a2d3f4d60aa72608d71a63a9a93c0f5', 1);
...
INSERT INTO `orus_db`.`roles` (`role`, `_user`, `_id`) VALUES ('ADMIN', '1', 1);
